...
Distributing a whole **product** — an MCP server plus skills, session hooks, and reflexes — is a [pack](/docs/concepts/packs); see [authoring a pack](/docs/guides/authoring-a-pack). Everything below is about single reflexes.
...
<Callout>
A reflex is code that runs with your permissions. Pull official reflexes by name, or read what you add from a URL first — see the [trust model](/docs/concepts/trust-model).
</Callout>

## Publishing to the commons

To make a reflex installable by short name, contribute it to the official catalog — see [Contributing](/docs/contributing).
